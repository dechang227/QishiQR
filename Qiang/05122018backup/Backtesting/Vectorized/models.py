...
class MajorSeriesTest:
    ...
    """
    def __init__(self, major_series, OUTPUT_DIR, prob_table, tca = None, px_th=0.0, window = 0):
        """
    ...
    def build(self, model_order=7, freq='5min', start='20161001', end='20161221', offset=0):
        """
        Read in Data and the probability table
        ...
        self.ensemble = ensembler(vectorizedbacktest, self.signals, tcas=self._tca, window = self._rollback_window)
        self.ensemble.build()
...
class MajorSeries_MaxPCT:
    ...
    Test ONE major series with different orders
    """
    def __init__(self, major_series, OUTPUT_DIR, prob_table, px_th=0.0, hcl_th = 0.5, window = 0):
        """
        Read in Data and the probability table
        Args:
            major_series: DataFrame, the time series of major conctrats. Generated by Utils.MajorContract_split
    ...
    def build(self, model_order=7, freq='5min', start='20161001', end='20161221', offset=0, tca=None):
        ...
        self.ensemble = ensembler(vectorizedbacktest, self.signals, tcas=tca, window = self._window, hcl_th = self._hcl_th)
        self.ensemble.build()
